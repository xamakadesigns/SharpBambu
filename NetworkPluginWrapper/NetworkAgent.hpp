...
namespace Slic3r {
    extern "C"
    {
        ...
        __declspec(dllexport) int send_message_to_printer(std::string dev_id, char* json_str, int qos);
        __declspec(dllexport) bool start_discovery(bool start, bool sending);
        __declspec(dllexport) int change_user(std::string user_info);
        ...
        __declspec(dllexport) void* network_agent{ nullptr };

        //func_check_debug_consistent         check_debug_consistent_ptr;
        //func_get_version                    get_version_ptr;
        //func_create_agent                   create_agent_ptr;
        //func_destroy_agent                  destroy_agent_ptr;
        //func_init_log                       init_log_ptr;
        //func_set_config_dir                 set_config_dir_ptr;
        //func_set_cert_file                  set_cert_file_ptr;
        //func_set_country_code               set_country_code_ptr;
        //func_start                          start_ptr;
        //func_set_on_ssdp_msg_fn             set_on_ssdp_msg_fn_ptr;
        //func_set_on_user_login_fn           set_on_user_login_fn_ptr;
        //func_set_on_printer_connected_fn    set_on_printer_connected_fn_ptr;
        //func_set_on_server_connected_fn     set_on_server_connected_fn_ptr;
        //func_set_on_http_error_fn           set_on_http_error_fn_ptr;
        //func_set_get_country_code_fn        set_get_country_code_fn_ptr;
        //func_set_on_message_fn              set_on_message_fn_ptr;
        //func_set_on_local_connect_fn        set_on_local_connect_fn_ptr;
        //func_set_on_local_message_fn        set_on_local_message_fn_ptr;
        //func_connect_server                 connect_server_ptr;
        //func_is_server_connected            is_server_connected_ptr;
        //func_refresh_connection             refresh_connection_ptr;
        //func_start_subscribe                start_subscribe_ptr;
        //func_stop_subscribe                 stop_subscribe_ptr;
        //func_send_message                   send_message_ptr;
        //func_connect_printer                connect_printer_ptr;
        //func_disconnect_printer             disconnect_printer_ptr;
        //func_send_message_to_printer        send_message_to_printer_ptr;
        //func_start_discovery                start_discovery_ptr;
        //func_change_user                    change_user_ptr;
        //func_is_user_login                  is_user_login_ptr;
        //func_user_logout                    user_logout_ptr;
        //func_get_user_id                    get_user_id_ptr;
        //func_get_user_name                  get_user_name_ptr;
        //func_get_user_avatar                get_user_avatar_ptr;
        //func_get_user_nickanme              get_user_nickanme_ptr;
        //func_build_login_cmd                build_login_cmd_ptr;
        //func_build_logout_cmd               build_logout_cmd_ptr;
        //func_build_login_info               build_login_info_ptr;
        //func_bind                           bind_ptr;
        //func_unbind                         unbind_ptr;
        //func_get_bambulab_host              get_bambulab_host_ptr;
        //func_get_user_selected_machine      get_user_selected_machine_ptr;
        //func_set_user_selected_machine      set_user_selected_machine_ptr;
        //func_start_print                    start_print_ptr;
        //func_start_local_print_with_record  start_local_print_with_record_ptr;
        //func_start_send_gcode_to_sdcard     start_send_gcode_to_sdcard_ptr;
        //func_start_local_print              start_local_print_ptr;
        //func_get_user_presets               get_user_presets_ptr;
        //func_request_setting_id             request_setting_id_ptr;
        //func_put_setting                    put_setting_ptr;
        //func_get_setting_list               get_setting_list_ptr;
        //func_delete_setting                 delete_setting_ptr;
        //func_get_studio_info_url            get_studio_info_url_ptr;
        //func_set_extra_http_header          set_extra_http_header_ptr;
        //func_get_my_message                 get_my_message_ptr;
        //func_check_user_task_report         check_user_task_report_ptr;
        //func_get_user_print_info            get_user_print_info_ptr;
        //func_get_printer_firmware           get_printer_firmware_ptr;
        //func_get_task_plate_index           get_task_plate_index_ptr;
        //func_get_slice_info                 get_slice_info_ptr;
        //func_query_bind_status              query_bind_status_ptr;
        //func_modify_printer_name            modify_printer_name_ptr;
        //func_get_camera_url                 get_camera_url_ptr;
        //func_start_pubilsh                  start_publish_ptr;
    };
}
